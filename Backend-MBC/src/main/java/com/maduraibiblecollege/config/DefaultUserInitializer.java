...
public class DefaultUserInitializer {
    ...
    public void init() {
        ...
        if (userRepository.findByUsername(DEFAULT_USERNAME).isEmpty() && userRepository.findByEmail(DEFAULT_EMAIL).isEmpty()) { //&& userRepository.findByEmail(DEFAULT_EMAIL).isEmpty()
